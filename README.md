...
This project develops an end-to-end pipeline: from simulating Byzantine-fault-tolerant swarm behaviors, to generating labeled datasets, to training machine-learning models that detect byzantine individuals in real time. By combining swarm simulations with ML & AI methods, this project shows a new way to enhance swarm security and resilience. While the exact implementation shown cannot be directly ported into a physical system, the project does shohw promise in the use of AI to improve cybersecurity in the field swarm robotics.
